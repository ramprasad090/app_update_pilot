...
class AppUpdatePilot {
  ...
  static Future<UpdateStatus> check({
    ...
    // Wait for the current frame to finish so any in-flight navigation on the
    // calling screen (pushReplacement, pushAndRemoveUntil, etc.) completes
    // before we push dialogs or walls onto the root navigator.
